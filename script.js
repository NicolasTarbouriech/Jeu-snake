window.onload = function()
{
    ...
    function gameOver()
    {
        ctx.save(); // enregistre les paramètres
        ctx.font = "bold 70px sans-serif";
        ctx.fillStyle = "#000"; // couleur d'ecriture
        ctx.textAlign = "center";
        ctx.textBaseline = "middle"; // le texte sera par rapport au milieu
    ...
    function drawScore() //afficher le score
    {
        ...
        ctx.fillStyle = "gray"; // couleur d'ecriture
        ctx.textAlign = "center";
        ctx.textBaseline = "middle"; // le texte sera par rapport au milieu
        var centreX = canvasWidth / 2; // centre des X
        var centreY = canvasHeight / 2;
